...
public class PersonalInfo extends JFrame{
	...
	JButton p_edit;
	JLabel p_close,p_min;
	private JPanel panel_1;
	private JPanel panel_2;
	//中部控件
	JLabel p_nicheng,p_wechatnumber,p_personal,p_guxiang,p_location,p_phone,p_mphone,p_zhuye,p_email,p_year,p_rname,p_xueli,p_school;
	...
	public PersonalInfo(String own){
		...
		p_edit = new JButton(new ImageIcon("image/Info/edit.jpg"));
		p_edit.setBounds(365, 223, 62, 21);
		p_edit.setFocusable(false);
		p_edit.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				AlterInfo alterinfo=new AlterInfo(owner);
				alterinfo.setTexts(str);
			   	alterinfo.getPersonalInfo(PersonalInfo.this);
		...
		panel_2.add(p_email);
		p_year = new JLabel("1");
		p_year.setBounds(110, 235, 227, 20);
		panel_2.add(p_year);
		...
		lbltime = new JLabel("Chat\u9F84");
		lbltime.setBounds(28, 238, 54, 15);
		panel_2.add(lbltime);
